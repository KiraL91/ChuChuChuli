...
XT_Wav_Class ChuliSound(Force);                                           // create WAV object and pass in the WAV data                                      
XT_MusicScore_Class Music(TwinkleTwinkle,TEMPO_ALLEGRO,INSTRUMENT_PIANO);   // The music score object, pass in the Music data

void setup() {
  ChuliSound.RepeatForever=true;       // Set this sample to play over and over again 
  ...
  DacAudio.Play(&ChuliSound,true);     // Play the sequence, will play just the once and then stop
}
