...
XT_Wav_Class ChuliSound(Force);     // create an object of type XT_Wav_Class that is used by 
...
void loop() {
  ...
  if(ChuliSound.Playing==false)       // if not playing,
    DacAudio.Play(&ChuliSound);       // play it, this will cause it to repeat and repeat...
